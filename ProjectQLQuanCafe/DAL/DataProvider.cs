...
namespace ProjectQLQuanCafe.DAL
{
    ...
    {
        private string connString = @"Data Source=TEUNGDUCS\SQLEXPRESS;Initial Catalog=QuanLyQuanCafe;Integrated Security=True";

        public static object Instance { get; internal set; }

        public SqlConnection getConnect()
        {
            return new SqlConnection(@"Data Source=TEUNGDUCS\SQLEXPRESS;Initial Catalog=QuanLyQuanCafe;Integrated Security=True");
        }
